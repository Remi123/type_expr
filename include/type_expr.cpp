...
int main() {
  ...
  auto sort_test = te::eval_pipe_<
      input<i<3>, i<1>, i<3>, i<4>, i<3>, i<1>, i<2>, i<3>, i<5>>,
      sort<less_<>>>{};
  ...
  auto fold_test =
      te::eval_pipe_<input<i<1>, i<2>, i<3>>, fold_left_<plus_<>>>{};
  ...
  te::eval_pipe_<input<ls_<int, i<0>>>, unwrap, pipe_<identity, second>> t12 =
      i<0>{};
  te::eval_pipe_<input<ls_<int, i<0>>>, unwrap, pipe_<second>> t13 = i<0>{};
  te::eval_pipe_<input<ls_<int, i<0>>>, pipe_<unwrap, pipe_<second>>> t14 =
      i<0>{};

  te::eval_pipe_<input<ls_<int, i<0>>>, pipe_<unwrap, first>, is_<int>> t15 =
      b<true>{};

  constexpr te::eval_pipe_<input<int>, unwrap,
                           is_<error_<type_expr::unwrap::unwrappable_type>>>
      t = b<true>{};
  ...
  constexpr te::eval_pipe_<input<ls_<int, float>>, pipe_<unwrap>,
                           is_<int, float>>
      pipe_unwrap4 = b<true>{};
  ...
  auto pipe_is_test_multi =
      te::eval_pipe_<input<i<1>, i<2>>, is_<i<1>, i<2>>>{};
  ...
  static_assert(te::eval_pipe_<input<char, char>, transform_<size>,
                               is_<i<1>, i<1>>>::value,
                "");
  ...
  static_assert(te::eval_pipe_<input<int, float, int, short>,
                               replace_if_<is_<int>, input<float>>,
                               is_<float, float, float, short>>::value,
                "");
  // replace_if transform the type into another if the predicate is true

  static_assert(
      te::eval_pipe_<input<ls_<int, short>, ls_<float, char>>, product,
  ...
  static_assert(te::eval_pipe_<input<i<1>, i<2>, i<3>, i<4>, i<5>>,
  ...
  static_assert(te::eval_pipe_<input<int, int, int>, all_of_<is_<int>>>::value,
                "");
  static_assert(
      te::eval_pipe_<input<int, float, int>, any_of_<is_<float>>>::value, "");
  static_assert(
      te::eval_pipe_<input<int, float, int>, none_of_<is_<char>>>::value, "");
  // Does exactly the same as their std:: counterpart

  static_assert(
      te::eval_pipe_<input<int, int, int>, pipe_<get_<0>>, is_<int>>::value,
      "");
  static_assert(te::eval_pipe_<input<i<1>, i<2>, i<3>>, get_<-1>, is_<>>::value,
                "");
  static_assert(
  ...
  static_assert(
      te::eval_pipe_<input<int, i<0>>,
                     cond_<pipe_<first, is_<int>>, input<std::true_type>,
                           input<std::false_type>>>::value,
      "");
  static_assert(te::eval_pipe_<input<float, int, float, int>,
